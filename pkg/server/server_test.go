...
func TestOperatorProfileDefaultTools(t *testing.T) {
	...
	assert.Contains(t, names, "mythic_cli_service")
	assert.Contains(t, names, "mythic_cli_health")
	assert.Contains(t, names, "mythic_cli_restart")
	assert.Contains(t, names, "mythic_cli_version")
	assert.Contains(t, names, "mythic_cli_config")
	assert.NotContains(t, names, "mythic_cli_database")
	assert.NotContains(t, names, "mythic_replace_installed_service")
